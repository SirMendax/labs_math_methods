...
def main():
    floatA = np.array(h.Helper.getRealBandMatrix(h.Helper.getMatrix('matrix.dat')), dtype = np.float32)
    floatB = np.array(h.Helper.getVector('vector.dat'), dtype = np.float32)

    doubleA = np.array(h.Helper.getRealBandMatrix(h.Helper.getMatrix('matrix.dat')), dtype = np.float64)
